            ...
            child: ChatWidgets.messageField(onSubmit: (controller) {
              if (controller.text.toString() != '') {
                if (roomId != null) {
                  ...
                  SendNotificationsService.name =
                      FirebaseAuth.instance.currentUser!.displayName!;
                  SendNotificationsService.body = controller.text;
                  print(SendNotificationsService.name);
                  print(SendNotificationsService.body);
                  SendNotificationsService().makeCall();
                } else {
                  Map<String, dynamic> data = {
                    'message': controller.text.trim(),
                    'sent_by': FirebaseAuth.instance.currentUser!.uid,
